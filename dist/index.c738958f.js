...
})({"k5uLS":[function(require,module,exports) {
...
$(document).ready(function() {
    ...
    $(".scoreList").click((e)=>{
        e.preventDefault();
        (0, _indexJs.displayLines)(e.target.id);
    });
    // PLAYER DISPLAY 
...
const playersRunDetails = (_playerId)=>{
    $.ajax({
        ...
        success: function(res) {
            const _resData = res;
            (0, _indexJs.displayRunMesh)(_resData); // INSIDE CONFIQ.JS   
            (0, _indexJs.wagonWheel)(_resData);
        }
    });
};
...
},{"../index.js":"8lqZg"}]},["k5uLS","efi6n"], "efi6n", "parcelRequire3a24")
