...
const model = new URL("../public/models/cricket_stadium.glb", import.meta.url).href;
$(document).ready(()=>{
    ...
    if (ZapparThree.browserIncompatible()) {
      ...
      const start = gltfLoader.load(model,(gltf) => {
        let mesh = gltf.scene;
        mesh.traverse((child)=>{
            if(child.type ==='Mesh'){
        ...
        (err) => {console.log("An error ocurred loading the GLTF model", err);}
      );
